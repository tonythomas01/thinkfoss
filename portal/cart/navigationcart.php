    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color: blue" ><i class="fa fa-shopping-cart"></i> <span class="badge"><?php echo $user->getEnrolledCourses( $conn ); ?> </span><span class="caret"></span></a>
