		...
		foreach( $courseList as $course ) {
			...
			if ( $course ) {
				...
				$merchentData = array(
						...
						'redirect_url' => 'http://www.thinkfoss.com/assets/php/vendor/cc_avenue_kit/ccavResponseHandler.php',
						'cancel_url' => 'http://www.thinkfoss.com/assets/php/vendor/cc_avenue_kit/ccavResponseHandler.php',
						'language' => 'en'
				);
